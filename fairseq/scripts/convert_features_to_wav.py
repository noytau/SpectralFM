...
# --- CONFIGURATION ---
input_pkl_dir = '/storage/noy/nova_samples/multi_chnl'   # Directory containing multiple .pkl files
output_wav_dir = '/storage/noy/SpectralFM/fairseq/data/nova_data/multi_channel/wavs'
manifest_dir = '/storage/noy/SpectralFM/fairseq/data/nova_data/multi_channel'
