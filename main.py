...
if __name__ == '__main__':
    ...
    dataset = prepare_masked_dataloader(single_chnl_df, interpolate_to_16k=False)
    ...
    # train only the feature extractor
    train_feature_extractor_only(model, optimizer, dataset, device)
