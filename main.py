...
if __name__ == '__main__':
    ...
    # fixme separate to train and evaluate/comput functions
    ...
    model_string = train_feature_extractor_only(model, optimizer, dataloader, device, parse_args.mask_ratio, parse_args.epoch, parse_args.batch_size, parse_args.loss_function, parse_args.run_id)
